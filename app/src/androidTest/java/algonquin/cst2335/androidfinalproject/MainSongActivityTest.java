...
public class MainSongActivityTest {
    ...
    public void mainSongActivityTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextSearch), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextSearch), withText("1"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("dc"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editTextSearch), withText("dc"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recyclerViewResults),
